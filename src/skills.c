...
/* Warrior Specs */
  ...
  SPEC_SKILL_ADD(CLASS_WARRIOR, 56, 100, SPEC_SWORDSMAN);//Changed from 40 9/25/2008 Zion
  SPEC_SKILL_ADD(CLASS_WARRIOR, 51, 80, SPEC_SWASHBUCKLER);
//  SPEC_SKILL_ADD(CLASS_WARRIOR, 51, 100, SPEC_GUARDIAN);
...
//  SPELL_ADD(CLASS_CABALIST, 1);
  ...
  SPELL_CREATE("sandstorm", SPELL_SANDSTORM, PULSE_SPELLCAST * 2,
                TAR_CHAR_ROOM | TAR_FIGHT_VICT | TAR_AGGRO, spell_sandstorm);
  SPELL_ADD(CLASS_BLIGHTER, 12);
...
//  SKILL_ADD(CLASS_CABALIST, 1, 100);
  ...
  SPEC_SKILL_ADD(CLASS_NECROMANCER, 1, 95, SPEC_REAPER);
  SPEC_SKILL_ADD(CLASS_THEURGIST, 1, 100, SPEC_THAUMATURGE);
  SPEC_SKILL_ADD(CLASS_REAVER, 30, 90, SPEC_SHOCK_REAVER); //Changed from 100 9/25/2008 Zion
  ...
  SKILL_ADD(CLASS_WARRIOR, 1, 100);
  SPEC_SKILL_ADD(CLASS_WARRIOR, 0, 0, SPEC_SWASHBUCKLER);
  SPEC_SKILL_ADD(CLASS_CLERIC, 1, 95, SPEC_ZEALOT);
...
//  SKILL_ADD(CLASS_CABALIST, 1, 100);
  ...
  SPEC_SKILL_ADD(CLASS_WARRIOR, 0, 0, SPEC_SWASHBUCKLER);
  SPEC_SKILL_ADD(CLASS_CLERIC, 1, 100, SPEC_ZEALOT);
  SPEC_SKILL_ADD(CLASS_NECROMANCER, 1, 90, SPEC_NECROLYTE);
  SPEC_SKILL_ADD(CLASS_THEURGIST, 1, 100, SPEC_TEMPLAR);
...
// Creating this bogus skill so only the person being throat crushed receives the wear off message.
  ...
  SPEC_SKILL_ADD(CLASS_ANTIPALADIN, 46, 100, SPEC_VIOLATOR);
