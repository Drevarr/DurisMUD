...
/* Warrior Specs */
  ...
  SKILL_CREATE("follow-up riposte", SKILL_FOLLOWUP_RIPOSTE,
               TAR_PHYS);
  SPEC_SKILL_ADD(CLASS_WARRIOR, 31, 60, SPEC_GUARDIAN);
...
/* Anti-paladin Specs */
  ...
  SPELL_CREATE("group heal", SPELL_GROUP_HEAL, PULSE_SPELLCAST * 3,
...
/* ranger specs */
  ...
  SPEC_SKILL_ADD(CLASS_BERSERKER, 41, 90, SPEC_MAULER);
...
/* a fun joke! -Tavril */
  ...
  SPELL_CREATE("death field", SPELL_DEATH_FIELD, PULSE_SPELLCAST * 2,
...
//  SPELL_ADD(CLASS_DRUID, 1);
  ...
  SPELL_CREATE("gate", SPELL_GATE, PULSE_SPELLCAST * 3,
                TAR_IGNORE | TAR_NOCOMBAT, cast_gate);
  SPELL_ADD(CLASS_CONJURER, 9);
  ...
  SPELL_ADD(CLASS_CLERIC, 10);
  SPEC_SPELL_ADD(CLASS_SHAMAN, 12, SPEC_SPIRITUALIST);
...
//  SPELL_ADD(CLASS_DRUID, 5);
  ...
  SPELL_CREATE("dispel magic", SPELL_DISPEL_MAGIC, PULSE_SPELLCAST * 2,
                TAR_CHAR_ROOM | TAR_FIGHT_VICT | TAR_OBJ_INV | TAR_OBJ_ROOM | TAR_AGGRO, spell_dispel_magic);
  SPELL_ADD(CLASS_CONJURER, 3);
  SPELL_ADD(CLASS_SORCERER, 4);
  SPELL_ADD(CLASS_NECROMANCER, 3);
...
//  SPELL_ADD(CLASS_BARD, 3);
  ...
  SPELL_CREATE("creeping doom", SPELL_CDOOM, PULSE_SPELLCAST * 3,
                TAR_CHAR_ROOM | TAR_FIGHT_VICT | TAR_AGGRO, spell_cdoom);
...
//  SPELL_ADD(CLASS_DRUID, 6);
  ...
  SPELL_CREATE("wall of ice", SPELL_WALL_OF_ICE, PULSE_SPELLCAST * 4,
  ...
  SPELL_ADD(CLASS_WARLOCK, 10);
  SPELL_CREATE("wall of stone", SPELL_WALL_OF_STONE, PULSE_SPELLCAST * 4,
                TAR_IGNORE | TAR_NOCOMBAT, cast_wall_of_stone);
  SPELL_ADD(CLASS_CONJURER, 5);

  SPELL_CREATE("wall of iron", SPELL_WALL_OF_IRON, PULSE_SPELLCAST * 5,
                TAR_IGNORE | TAR_NOCOMBAT, cast_wall_of_iron);
  SPELL_ADD(CLASS_CONJURER, 6);

  SPELL_CREATE("wall of force", SPELL_WALL_OF_FORCE, PULSE_SPELLCAST * 5,
...
//  SKILL_ADD(CLASS_DRUID, 1, 100);
  ...
  SKILL_ADD(CLASS_NECROMANCER, 1, 65);
//  SKILL_ADD(CLASS_ROGUE, 1, 60);
  SKILL_ADD(CLASS_THIEF, 1, 60);
  SKILL_ADD(CLASS_SHAMAN, 1, 60);
  SKILL_ADD(CLASS_ETHERMANCER, 1, 85); //Changed from 100 9/25/2008 Zion
  SKILL_ADD(CLASS_ALCHEMIST, 1, 100);
  SKILL_ADD(CLASS_BERSERKER, 1, 100);
  ...
  SPEC_SKILL_ADD(CLASS_ROGUE, 1, 50, SPEC_ASSASSIN);
  SPEC_SKILL_ADD(CLASS_REAVER, 30, 90, SPEC_SHOCK_REAVER);
  ...
  SKILL_ADD(CLASS_WARLOCK, 1, 50);
  SKILL_ADD(CLASS_ROGUE, 1, 95); //Changed from 100 9/25/2008 Zion
  SKILL_ADD(CLASS_THIEF, 1, 100);
  SKILL_ADD(CLASS_WARRIOR, 1, 100);
  SKILL_ADD(CLASS_ILLUSIONIST, 1, 50);
  SPEC_SKILL_ADD(CLASS_NECROMANCER, 1, 90, SPEC_REAPER);
  SPEC_SKILL_ADD(CLASS_REAVER, 30, 95, SPEC_SHOCK_REAVER); //Changed from 100 9/25/2008 Zion
...
//  SPELL_ADD(CLASS_DRUID, 8);
  ...
  SPELL_CREATE("create spring", SPELL_CREATE_SPRING, PULSE_SPELLCAST * 6,
...
//  SPELL_ADD(CLASS_RANGER, 11);
  ...
  SPELL_CREATE("shadow gate", SPELL_SHADOW_GATE, PULSE_SPELLCAST * 10,
  ...
  SKILL_ADD(CLASS_ROGUE, 1, 60);
  SKILL_ADD(CLASS_ASSASSIN, 1, 100);
  SKILL_ADD(CLASS_THIEF, 1, 65);
  SKILL_ADD(CLASS_MERCENARY, 1, 65);
  SKILL_ADD(CLASS_BARD, 1, 65);
  SPEC_SKILL_ADD(CLASS_BARD, 1, 95, SPEC_SCOUNDREL);
  SPEC_SKILL_ADD(CLASS_ROGUE, 1, 100, SPEC_ASSASSIN);
  SPEC_SKILL_ADD(CLASS_ROGUE, 1, 65, SPEC_THIEF);
...
// Creating this bogus skill so only the person being throat crushed receives the wear off message.
  ...
  SKILL_ADD(CLASS_ANTIPALADIN, 31, 85);
  ...
  SKILL_ADD(CLASS_RANGER, 46, 95);
  SKILL_ADD(CLASS_REAVER, 51, 80);
  SKILL_ADD(CLASS_MERCENARY, 53, 60);
  SKILL_ADD(CLASS_BERSERKER, 46, 80);
  SKILL_ADD(CLASS_PALADIN, 56, 50);
  SKILL_ADD(CLASS_ANTIPALADIN, 56, 60);
  ...
  SKILL_ADD(CLASS_ROGUE, 1, 75);
  SKILL_ADD(CLASS_MERCENARY, 1, 80);
  SKILL_ADD(CLASS_BERSERKER, 11, 80);
  SKILL_ADD(CLASS_REAVER, 1, 80);
  SPEC_SKILL_ADD(CLASS_WARRIOR, 31, 100, SPEC_SWASHBUCKLER);
  SPEC_SKILL_ADD(CLASS_ROGUE, 1, 90, SPEC_ASSASSIN);
  ...
  SPEC_SKILL_ADD(CLASS_WARRIOR, 41, 80, SPEC_SWASHBUCKLER);
...
//  SKILL_ADD(CLASS_REAVER, 1, 60);
  ...
  SPEC_SKILL_ADD(CLASS_CLERIC, 30, 90, SPEC_ZEALOT);
  SPEC_SKILL_ADD(CLASS_ROGUE, 25, 80, SPEC_THIEF);
  SPEC_SKILL_ADD(CLASS_DRUID, 31, 60, SPEC_WOODLAND);
  ...
  SKILL_ADD(CLASS_PALADIN, 1, 65);
  SKILL_ADD(CLASS_ANTIPALADIN, 1, 65);
  SKILL_ADD(CLASS_RANGER, 1, 100);
  SKILL_ADD(CLASS_MERCENARY, 1, 60);
  SKILL_ADD(CLASS_WARRIOR, 1, 100);
  SKILL_ADD(CLASS_BERSERKER, 6, 50);
  SKILL_ADD(CLASS_REAVER, 26, 50);
