...
/* Warrior Specs */
  ...
  SPEC_SKILL_ADD(CLASS_WARRIOR, 51, 60, SPEC_SWORDSMAN);//Changed from 40 9/25/2008 Zion
...
// lets go back to having epic skills instead of pure racial skills Zion 4/8/2014
