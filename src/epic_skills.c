...
epic_reward epic_rewards[] = {
  {EPIC_REWARD_SKILL, SKILL_ANATOMY, 25, 1, 250000,
  ...
  {EPIC_REWARD_SKILL, SKILL_ADVANCED_MEDITATION, 25, 1, 250000,
   CLASS_SORCERER | CLASS_CONJURER | CLASS_ILLUSIONIST |
  ...
  {EPIC_REWARD_SKILL, SKILL_TOUGHNESS, 100, 25, 500000,
    0 },
  {EPIC_REWARD_SKILL, SKILL_SPATIAL_FOCUS, 100, 100, 1000000, CLASS_PSIONICIST},
...
//    0 },
  ...
  CLASS_DRUID },
  {EPIC_REWARD_SKILL, SKILL_EXPERT_PARRY, 1000, 200,  2000000,
   CLASS_WARRIOR | CLASS_PALADIN | CLASS_RANGER},
  {EPIC_REWARD_SKILL, SKILL_EXPERT_RIPOSTE, 1000, 200, 2000000,
   CLASS_WARRIOR | CLASS_ANTIPALADIN | CLASS_DREADLORD | CLASS_AVENGER},
  {EPIC_REWARD_SKILL, SKILL_EPIC_STRENGTH, 100, 25, 250000,
    0 },
  {EPIC_REWARD_SKILL, SKILL_EPIC_POWER, 100, 25, 250000,
    0 },
  {EPIC_REWARD_SKILL, SKILL_EPIC_AGILITY, 100, 25, 250000,
    0 },
  {EPIC_REWARD_SKILL, SKILL_EPIC_INTELLIGENCE, 100, 25, 250000,
    0 },
  {EPIC_REWARD_SKILL, SKILL_EPIC_DEXTERITY, 100, 25, 250000,
    0 },
  {EPIC_REWARD_SKILL, SKILL_EPIC_WISDOM, 100, 25, 250000,
    0 },
  {EPIC_REWARD_SKILL, SKILL_EPIC_CONSTITUTION, 100, 25, 250000,
    0 },
  {EPIC_REWARD_SKILL, SKILL_EPIC_CHARISMA, 100, 25, 250000,
    0 },
  {EPIC_REWARD_SKILL, SKILL_EPIC_LUCK, 100, 25, 250000,
    0 },
