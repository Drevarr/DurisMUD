...
void assign_innates()
{
  ...
  ADD_RACIAL_INNATE(INNATE_BARB_BREATH, RACE_BARBARIAN, 11);
...
// Demons and devils
  ...
  ADD_CLASS_INNATE(INNATE_ENTRAPMENT, CLASS_MERCENARY, 30, 0);  
...
void do_shift_prime(P_char ch, char *arg, int cmd)
{
  ...
  const int githzerai_room[] = {
    41767, 20484, 6224, 66651, 7117, 93665, 16805, 5759, 2018, 77422, 99295, 93919, 16302, 574427, 557620
  };
