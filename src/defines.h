...
#define AFF5_DECAYING_FLESH     BIT_26
#define AFF5_DREADNAUGHT	    BIT_27
...
#define RACE_W_ELEMENTAL     42 /* mob race code: EW */
#define RACE_E_ELEMENTAL     43 /* mob race code: EE */
#define RACE_DEMON           44 /* mob race code: X  */
#define RACE_DEVIL           45 /* mob race code: Y  */
#define RACE_UNDEAD          46 /* mob race code: U  */
#define RACE_VAMPIRE         47 /* mob race code: UV */
#define RACE_GHOST           48 /* mob race code: UG */
#define RACE_LYCANTH         49 /* mob race code: L  */
#define RACE_GIANT           50 /* mob race code: G  */
#define RACE_HALFORC         51 /* mob race code: H2 */
#define RACE_GOLEM           52 /* mob race code: OG */
#define RACE_FAERIE          53 /* mob race code: HF */
#define RACE_DRAGON          54 /* mob race code: D  */
#define RACE_DRAGONKIN       55 /* mob race code: DK */
#define RACE_REPTILE         56 /* mob race code: R  */
#define RACE_SNAKE           57 /* mob race code: RS */
#define RACE_INSECT          58 /* mob race code: I  */
...
#define RACE_PLANT           66 /* mob race code: VT */
#define RACE_HERBIVORE       67 /* mob race code: AH */
#define RACE_CARNIVORE       68 /* mob race code: AC */
#define RACE_PARASITE        69 /* mob race code: AP */
#define RACE_BEHOLDER        70 /* mob race code: BH */
#define RACE_DRACOLICH       71 /* mob race code: UD */
#define RACE_SLIME           72 /* mob race code: SL */
#define RACE_ANGEL           73 /* mob race code: AN */
#define RACE_RAKSHASA        74 /* mob race code: RA */
#define RACE_CONSTRUCT       75 /* mob race code: CN */
#define RACE_EFREET          76 /* mob race code: E  */
#define RACE_SNOW_OGRE       77 /* mob race code: SO */
#define RACE_BEHOLDERKIN     78 /* mob race code: BK */
#define RACE_ZOMBIE          79 /* mob race code: ZO */
#define RACE_SPECTRE         80 /* mob race code: SP */
#define RACE_SKELETON        81 /* mob race code: SK */
