...
#define RAWDAM_DEFAULT (RAWDAM_TRANCEVAMP | RAWDAM_BTXVAMP | RAWDAM_SHRTVMP | \
  RAWDAM_HOLYSAC | RAWDAM_SANCTUARY | RAWDAM_IMPRISON | RAWDAM_VINES)
