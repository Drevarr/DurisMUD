...
#define EQ_WIPE 20000000 // Comment out before pwipe.
...
//void reroll_basic_abilities(P_char);
...
void cast_wall_of_flames(int, P_char, char *, int, P_char, P_obj);
void cast_wall_of_ice(int, P_char, char *, int, P_char, P_obj);
